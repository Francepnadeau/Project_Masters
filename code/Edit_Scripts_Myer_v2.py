...
def EDIT_SCRIPTS_gap(word,d,prefix,Sigma,i,final):
    ...
    if k<=d or d==0:  #stopping condition, rebuild the edit script by putting the prefix with the rest of the word
        ...
        while transit != []:
            ...
            EDIT_SCRIPTS_gap(word,d,prefix,Sigma,1,final_words)  
    return(final_words)
    
#-----------------------------------------------------------------------------            
# deleting the '-' in the words generated in final_words
                          
def EDIT_SCRIPTS(word,d,prefix,Sigma,i,final):
    final_words=EDIT_SCRIPTS_gap(word,d,prefix,Sigma,i,final)
...
#-----------------------------------------------------------------------------
# We count the number of words that repeat in the list of final edit scripts without gaps
                              
def repeating_words(word,d,prefix,Sigma,i,final):
    final_words=EDIT_SCRIPTS(word,d,prefix,Sigma,i,final)
    repeats=[]
    counter=0
