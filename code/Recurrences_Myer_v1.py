...
# We use the parameters 'k' for the length of the word, 'd' for the edit distance and 's' for the number of elements in the alphabet.
...
#-----------------------------------------------------------------------------
def S(k,d,s):  #putting together the recurrences
    if k<=d or d==0:
        return(1)
    else:
